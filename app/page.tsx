...
const actions = [
  {
    label: "Ver Instagram",
    href: "https://instagram.com/tatianachilio",
    icon: Instagram,
  },
  {
  ...
  {
    label: "Localização",
    href: "https://maps.google.com/?q=Bauru+SP",
    icon: MapPin,
  },
  {
...
const products = [
  {
    ...
    description:
      "Chocolate nobre com acabamento delicado e apresentação especial para presentear.",
  ...
  },
  {
    ...
    description:
      "Camadas cremosas e sabor marcante em uma criação artesanal feita para surpreender.",
    badge: "Mais Pedido",
  ...
  },
  {
    ...
    description:
      "Versão premium da coleção de Páscoa, com visual elegante e proposta irresistível.",
      ...
      <div className="relative mx-auto flex w-full max-w-xl flex-col gap-4 sm:gap-5">
        ...
        >
          <div className="flex flex-col gap-4">
            <span className="inline-flex w-fit items-center gap-2 rounded-full bg-white/80 px-3 py-1 text-[11px] font-semibold text-mauveText">
              <Sparkles size={13} /> Encomendas especiais para Páscoa e
              celebrações
            </span>

            <div className="flex justify-center">
              <div className="relative h-36 w-36 overflow-hidden rounded-full border border-white/80 bg-gradient-to-br from-premiumPink via-softPink to-lightBlush p-1 shadow-softGlow">
                <div className="relative h-full w-full overflow-hidden rounded-full bg-white/85">
                  <Image
                    src="/tatiana-perfil.jpg"
                    alt="Foto de perfil de Tatiana Chilio"
                    fill
            ...
            <div>
              ...
              <p className="mt-1 text-sm font-medium text-mauveText">
                Confeitaria artesanal com coleção especial de Páscoa
              </p>
              <p className="mt-3 text-sm leading-relaxed text-mauveText">
                Bolos, pudins e doces artesanais com apresentação delicada para
                tornar datas especiais ainda mais memoráveis.
              </p>
            </div>
          </div>
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            {infoChips.map((chip) => (
              <span
                key={chip}
                className="rounded-full border border-white/70 bg-white/70 px-3 py-1 text-[11px] font-medium text-mauveText"
              >
                {chip}
              </span>
            ))}
          ...
          <div className="grid grid-cols-1 gap-2.5 sm:grid-cols-2 sm:gap-3">
            {actions.map(({ label, href, icon: Icon }) => (
              ...
              >
                ...
                <Icon
                  size={16}
                  className="text-accentPink transition group-hover:translate-x-0.5"
                />
              </a>
            ))}
          </div>
        ...
        >
          <div className="mb-4 flex items-center justify-between">
            ...
            <span className="rounded-full bg-white/75 px-3 py-1 text-[11px] font-semibold text-mauveText">
              Vitrine Premium
            </span>
          </div>
        ...
        >
          ...
          <ul className="mt-3 grid gap-2">
            {highlights.map((item) => (
              <li
                key={item}
                className="flex items-center gap-2 text-sm text-mauveText"
              >
